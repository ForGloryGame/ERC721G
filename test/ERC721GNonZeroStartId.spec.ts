...
import { ERC721ReceiverMock, ERC721GStartIdMock } from "../typechain";

describe("ERC721GNonZeroStartId.spec.ts", async () => {
  const StartTokenId = 10;

  let erc721g: ERC721GStartIdMock;
  ...
  beforeEach(async () => {
    ...
    const ERC721GStartIdMock = await ethers.getContractFactory("ERC721GStartIdMock", deployer);
    erc721g = await ERC721GStartIdMock.deploy("ERC721G name", "ERC721G symbol");
    await erc721g.deployed();
