...
import { IERC721GUpgradeable, IERC721MetadataUpgradeable, IERC721EnumerableUpgradeable } from "./interfaces/IERC721GUpgradeable.sol";
...
contract ERC721GUpgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721GUpgradeable {
  ...
  function approve(address to, uint256 tokenId) public override {
    address owner = ERC721GUpgradeable.ownerOf(tokenId);
  ...
  function _transfer(
    ...
    require(ERC721GUpgradeable.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
